 ...
 (function ($, window, undefined) {
	...
	var rhinoSlider = function (element, opts) {
		...
		var
			setUpSettings = function (settings) {
				...
				settings.effectTime = parseInt(settings.effectTime, 0);
			...
			init = function ($slider, settings, vars) {
				...
				if (settings.showBullets !== 'never') {
					...
					vars.buttons.bullets.mouseenter(function () {
					...
					vars.buttons.bullets.mouseleave(function () {
				...
				$('<div class="util-area"></div>').appendTo(".rhino-container");
				$('<a href="/event/Calender/calender.asp" target="_blank" class="util-calendar"></a>').appendTo(".rhino-container");
			},
	...
	$.fn.rhinoslider.effects = {
		...
		slide: function ($slider, params, callback) {
			...
			values.easing = settings.showTime === 0 ? 'liner' : settings.easing;
			values.nextEasing = settings.showTime === 0 ? 'liner' : settings.easing;
