...
swiper.on("slideChange", function (e) {
  ...
  currentIndex !== 3 &&
    document
      .querySelector(".section03-img-bg")
      .removeEventListener("mousemove", handelMouseMove, false);
  currentIndex === 5
    ? document.querySelector(".footer").classList.remove("hides")
    : document.querySelector(".footer").classList.add("hides");
});
...
function section01Animate() {
  /*section01 event*/
  section01ScrollMotion
    .fromTo(".left-side-text", { y: -5, ease: "expo.out" }, { y: 0 })
    .fromTo(
      ".section01-img-bg .section01-polygon-item01",
      { y: -150, ease: "expo.out" },
      { y: 0 },
      ">"
    )
    .fromTo(
      ".section01-img-bg .section01-polygon-item02",
      1,
      { y: -150, ease: "expo.out" },
      { y: 0 },
      ">"
    ...
    .fromTo(
      ".section01-img-bg .section01-polygon-item03",
      1,
      { y: 300, ease: "expo.out" },
      { y: 0 },
      "<"
    ...
    .fromTo(
      ".section01-img-bg .section01-alphabet-b",
      1,
      { opacity: 0, y: 150, ease: "expo.out" },
      {
        opacity: 1,
        y: 0,
      },
    ...
    .fromTo(
      ".section01-img-bg .section01-alphabet-n01",
      1,
      { opacity: 0, y: 250, ease: "expo.out" },
      {
        opacity: 1,
        y: 0,
      },
    ...
    .fromTo(
      ".section01-img-bg .section01-polygon-item04",
      { opacity: 0, y: 400, ease: "expo.out" },
      {
        opacity: 1,
        y: 0,
      },
    ...
    .fromTo(
      ".section01-img-bg .section01-alphabet-n02",
      1,
      { opacity: 0, y: 250, ease: "expo.out" },
      {
        opacity: 1,
    ...
    .fromTo(
      ".section01-img-bg .section01-alphabet-r",
      1,
      { opacity: 0, y: 250, ease: "expo.out" },
      {
        opacity: 1,
    ...
    .fromTo(
      ".section01-img-bg .section01-polygon-item05",
      1,
      { opacity: 0, y: 400, ease: "expo.out" },
      {
        opacity: 1,
  ...
  section01Item
    .fromTo(
      ".section01-top-text",
      { delay: 1, opacity: 0, y: -60, ease: "expo.out" },
      {
        delay: 1,
        opacity: 1,
        y: 0,
    ...
    .fromTo(
      ".section01-md-text",
      1,
      { opacity: 0, y: -60, ease: "expo.out" },
      { opacity: 1, y: 0 }
    )
    .fromTo(
      ".section01-bottom-text",
      1,
      { opacity: 0, y: -60, ease: "expo.out" },
      { opacity: 1, y: 0 },
      "<"
...
function section02Animate() {
  ...
  section02Item
    ...
    .fromTo(
      ".section02-text-01 span",
      2.5,
      { width: 0, ease: "expo.out" },
      { width: "100%" },
      "<"
    )
    .fromTo(
...
function section02AnimateReset() {
  section02Item
    .to(".section02-icon span", { opacity: 0 })
...
function section03Animate() {
  ...
  section03Item
    ...
    .fromTo(
      ...
      1,
      { width: 0, delay: 0.4, ease: "expo.out" },
      { width: "100%", delay: 0.4 },
      "<"
    )
    .fromTo(
      ".section03-bottom-text span",
      1,
      { width: 0, ease: "expo.out" },
      { width: "100%" },
      "<"
    ...
    .to(
      ...
      2,
      {
        update: () => {
          ...
          document
            .querySelector(".section03-img-bg")
            .addEventListener("mousemove", handelMouseMove, false);
        },
      },
      ">"
    );
...
function section03AnimateReset() {
  ...
  section03Item
    .to(".section03-icon span", { opacity: 0 })
...
function section04Animate() {
  ...
  section04Item
    .fromTo(
      ".section04 .bg1",
      1,
      { y: 50, x: 600, ease: "expo.out" },
      { y: 0, x: 0 }
    )
    .fromTo(
      ".section04 .bg2",
      1,
      { y: 150, x: -600, ease: "expo.out" },
      { y: 0, x: 0 },
      "<"
    )
    .fromTo(
